...
A Helm chart for [order orchestration]/[orchestration delivery] service
...
| image.repository | string | `"registry.gitlab.tech.orange/disco/disco-oda-components/disco-order-orchestration/orchestration-delivery/snapshot"` |  |
| image.tag | string | `"1-7-0"` |  |
| imagePullSecrets[0].name | string | `"gitlab.orchestration-delivery-tech-pull-token"` |  |
...
| od.service.fallout | string | `""` |  |
| od.service.kafka | string | `""` |  |
...
| plan.deletePlanThresholdDuration | string | `""` |  |
