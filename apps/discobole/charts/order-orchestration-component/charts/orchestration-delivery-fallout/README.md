...
A Helm chart for [order orchestration]/[orchestration delivery fallout] service
...
```bash
helm install my-release disco-stable-repo/orchestration-delivery-fallout
```
...
| image.repository | string | `"registry.gitlab.tech.orange/disco/disco-oda-components/disco-order-orchestration/orchestration-delivery-fallout/snapshot"` |  |
| image.tag | string | `"2-0-0"` |  |
| imagePullSecrets[0].name | string | `"gitlab.orchestration-delivery-fallout-tech-pull-token"` |  |
| ingress.enabled | bool | `false` |  |
| keycloak.clientId | string | `""` |  |
| keycloak.clientSecret | string | `""` |  |
| keycloak.enabled | bool | `false` |  |
| keycloak.uri | string | `""` |  |
| mongo.arbiter.service.nameOverride | string | `""` |  |
...
| registryCredentials.create | bool | `true` |  |
...
```console
$ helm install my-release -f values.yaml disco-stable-repo/orchestration-delivery-fallout
```
