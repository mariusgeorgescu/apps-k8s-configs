...
A Helm chart for [order management]/[order follow up] service
...
| image.repository | string | `"registry.gitlab.tech.orange/disco/disco-oda-components/disco-order-management/order-followup/snapshot"` |  |
...
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
| of.service.kafka | string | `""` |  |
| of.service.mxHeap | string | `""` |  |
| of.service.productInventory | string | `""` |  |
