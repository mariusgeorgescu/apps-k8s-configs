...
| image.repository | string | `"registry.gitlab.tech.orange/disco/disco-oda-components/disco-order-management/mock-server/snapshot"` |  |
| image.tag | string | `"1-13-0"` |  |
| ingress.enabled | bool | `false` |  |
| istio.enabled | bool | `false` |  |
| mockServer.service.mxHeap | string | `""` |  |
