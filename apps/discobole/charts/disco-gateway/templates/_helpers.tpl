...
application: {{ default "gateway" .Values.monitoring.application }}
...
{{- printf "%s , \"instance\": \"%s\", \"name\": \"%s\", \"productname\": \"%s\", \"setname\": \"%s\", \"container_name\": \"event-service\"" .Values.fluentd.sidecar.loki.extra_labels .Release.Name (include "catalog.name" .) (default .Chart.Name .Values.monitoring.productName) (include "catalog.fullname" .) }}
{{- end -}}