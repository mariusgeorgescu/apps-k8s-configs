...
# Catalog-Product-Specification-workflow
...
```bash
helm install catalog-product-specification disco-diod-central/catalog-product-specification
```
...
```bash
$ helm install --name my-release disco-diod-central/catalog-product-specification
```
...
```bash
$ helm install my-release disco-diod-central/catalog-product-specification
...
```console
$ helm install my-release -f values.yaml disco-diod-central/catalog-product-specification
```
...
```bash
$ helm install --name my-release disco-diod-central/guide-development-workflow \
