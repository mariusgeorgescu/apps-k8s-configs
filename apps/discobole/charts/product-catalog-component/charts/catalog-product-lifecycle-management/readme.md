...
```bash
helm install lifecycle-management disco-diod-central/lifecycle-management
```
...
```bash
$ helm install --name my-release disco-diod-central/lifecycle-management
```
...
```bash
$ helm install my-release disco-diod-central/lifecycle-management
...
```console
$ helm install my-release -f values.yaml disco-diod-central/lifecycle-management
```
