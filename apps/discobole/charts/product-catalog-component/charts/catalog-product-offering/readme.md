...
| fluentd.tag | string | `"catalog-product-offering"` |  |
...
| monitoring.application | string | `"catalog-product-offering"` |  |
...
| services.catalogadminstration | string | `"catalog-product-catalog-administration:8080"` |  |
| services.catalogui | string | `"catalog-ui:80"` |  |
| services.category | string | `"catalog-product-category:8080"` |  |
| services.catprodcaturl | string | `"https://catalog-product-catalog"` |  |
