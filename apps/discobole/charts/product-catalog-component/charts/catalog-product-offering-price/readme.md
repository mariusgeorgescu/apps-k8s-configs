...
A Helm chart for [disco-catalog]/[catalog product offering price] service
...
```bash
helm install my-release disco-stable-repo/catalog-product-offering-price
```
...
| fluentd.tag | string | `"catalog-product-offering-price"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"Always"` |  |
| image.repository | string | `"${CI_REGISTRY}/${CI_PROJECT_PATH}/snapshot"` |  |
| image.tag | string | `"${CI_COMMIT_REF_SLUG}"` |  |
...
| monitoring.application | string | `"catalog-product-offering-price"` |  |
...
| services.catprodcaturl | string | `"https://catalog-product-catalog-disco.apps.fr01.paas.tech.orange"` |  |
...
```console
$ helm install my-release -f values.yaml disco-stable-repo/catalog-product-offering-price
```
