...
A Helm chart for [product-inventory]/[customer product installed base] service
...
| image.repository | string | `"registry.gitlab.tech.orange/disco/disco-oda-components/disco-product-inventory/product-inventory/snapshot"` |  |
| image.tag | string | `"1-15-0"` |  |
| ingress.enabled | bool | `false` |  |
| keycloak.clientSecret | string | `""` |  |
| keycloak.enabled | bool | `false` |  |
| keycloak.issuerURI | string | `""` |  |
| mongo.architecture | string | `"replicaset"` |  |
...
| mongo.podAnnotations."prometheus.io/port" | string | `""` |  |
| mongo.podAnnotations."prometheus.io/scrape" | string | `""` |  |
| mongo.replicaCount | int | `1` |  |
| mongo.resources.limits.memory | string | `""` |  |
...
| productInventory.service.inventoryResource | string | `""` |  |
| productInventory.service.kafka | string | `""` |  |
| productInventory.service.pagination.limit | string | `"10000"` |  |
| productInventory.service.productCatalog | string | `""` |  |
| productInventory.service.productCatalogEnable | string | `""` |  |
| productInventory.service.resourceInventoryManagementEnable | string | `"false"` |  |
| productInventory.service.userRoleRetrieval | string | `""` |  |
| productInventory.service.userRoleValidationEnable | string | `"false"` |  |
